module "rds" {
  ...
  master_user_password_rotate_immediately                = try(each.value.master_user_password_rotate_immediately, var.rds_defaults.master_user_password_rotate_immediately, null)
  master_user_password_rotation_automatically_after_days = try(each.value.master_user_password_rotation_automatically_after_days, var.rds_defaults.master_user_password_rotation_automatically_after_days, null)
  master_user_password_rotation_duration                 = try(each.value.master_user_password_rotation_duration, var.rds_defaults.master_user_password_rotation_duration, null)
  master_user_password_rotation_schedule_expression      = try(each.value.master_user_password_rotation_schedule_expression, var.rds_defaults.master_user_password_rotation_schedule_expression, null)
  ...
  subnet_ids                      = try(each.value.subnet_ids, var.rds_defaults.subnet_ids, data.aws_subnets.this[each.key].ids)
  ...
  option_group_skip_destroy    = try(each.value.option_group_skip_destroy, var.rds_defaults.option_group_skip_destroy, null)
  ...
  upgrade_storage_config = try(each.value.upgrade_storage_config, var.rds_defaults.upgrade_storage_config, null)
  ...
  domain_auth_secret_arn              = try(each.value.domain_auth_secret_arn, var.rds_defaults.domain_auth_secret_arn, null)
  domain_dns_ips                      = try(each.value.domain_dns_ips, var.rds_defaults.domain_dns_ips, null)
  domain_fqdn                         = try(each.value.domain_fqdn, var.rds_defaults.domain_fqdn, null)
  domain_iam_role_name                = try(each.value.domain_iam_role_name, var.rds_defaults.domain_iam_role_name, null)
  domain_ou                           = try(each.value.domain_ou, var.rds_defaults.domain_ou, null)
  ...
  monitoring_role_permissions_boundary   = try(each.value.monitoring_role_permissions_boundary, var.rds_defaults.monitoring_role_permissions_boundary, null)
  cloudwatch_log_group_skip_destroy      = try(each.value.cloudwatch_log_group_skip_destroy, var.rds_defaults.cloudwatch_log_group_skip_destroy, null)
  cloudwatch_log_group_class             = try(each.value.cloudwatch_log_group_class, var.rds_defaults.cloudwatch_log_group_class, null)
  ...
  nchar_character_set_name = try(each.value.nchar_character_set_name, var.rds_defaults.nchar_character_set_name, null)

  ## MySQL
  s3_import = try(each.value.s3_import, var.rds_defaults.s3_import, null)

  # DB Instance Role Association
  db_instance_role_associations = try(each.value.db_instance_role_associations, var.rds_defaults.db_instance_role_associations, {})
